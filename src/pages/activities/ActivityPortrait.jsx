...
function ActivityPortrait({ user }) {
  ...
  return (
    <ActivityLayout title="어진 비교">
      <div className="activity-section">
        <div className="input-group">
          <label><strong>1층</strong> 왼쪽의 그림은 임금의 초상화 '어진'입니다. 아래 어진과의 차이점은 무엇일까요?</label>
          <textarea
            value={difference}
        ...
        <div className="input-group">
          <label><strong>2층</strong> 그러한 차이점이 생긴 이유는 무엇일까요?</label>
          <textarea
            value={reason}
        ...
        <div className="input-group">
          <label><strong>3층</strong> 대한제국을 상징하는 문양이 담긴 유물을 찾아보세요. 그리고 문양의 이름을 적어보세요.</label>
          <input
            type="text"
            value={symbolName}
